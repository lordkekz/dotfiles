# KDE Plasma 6 base config, created from fresh upgrade
{
  programs.plasma = {
    ...
    configFile = {
      "baloofilerc"."General" = {
        "exclude folders" = "$HOME/,$HOME/git/nixpkgs,$HOME/git/home-manager";
        "folders" = "$HOME/Desktop/,$HOME/Documents/,$HOME/Downloads/,$HOME/Music/,$HOME/Pictures/,$HOME/git/uni-bachelor,$HOME/git/uni-proseminar";
        "dbVersion" = 2;
